...
//
//@HiltViewModel
//class DocumentsViewModel @Inject constructor(private val documentRepository: DocumentRepository) :
//    ViewModel() {
...
//
//    private val _studySetResponse = MutableLiveData<UserResponse>()
//    val studySetResponse: LiveData<UserResponse> get() = _studySetResponse
//
//
...
//                result.fold(
//                    onSuccess = { _studySetResponse.postValue(it) },
//                    onFailure = { Timber.e(it, "Error creating StudySet") }
//                )
//            } catch (e: Exception) {
