...
import com.example.quizletappandroidv1.databinding.FragmentTranslateBinding
...
class Translate : Fragment(), OnInitListener {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        sharedPreferences =
            requireContext().getSharedPreferences("chooseLanguage", Context.MODE_PRIVATE)
        ...
        binding.imgChooseImage.setOnClickListener {
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.R) {
                ...
                if (ContextCompat.checkSelfPermission(
                    ...
                    ImagePicker.with(requireActivity()).compress(1024).maxResultSize(
                        1080, 1080
                    ).start()
                } else {
    ...
    private fun getSourceChoose() {
        val popupMenu = PopupMenu(requireContext(), binding.txtResouseLanguage)
